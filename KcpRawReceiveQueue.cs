...
#else
using LinkedListOfQueueItem = System.Collections.Generic.LinkedList<HyacineCore.Server.Kcp.KcpSharp.KcpBuffer>;
using LinkedListNodeOfQueueItem =
    System.Collections.Generic.LinkedListNode<HyacineCore.Server.Kcp.KcpSharp.KcpBuffer>;
#endif
